...
AF3_DIR="/home/rachel/07_fold_all/effector_p/af3/alphafold3-3.0.3/output"
AF3_CIF="/home/rachel/08_cluster_all/effector_p/af3/cif"
AF3_TMP="/linuxhome/tmp/${USER}/alphafold3/"
FDSK_OUT="/home/rachel/08_cluster_all/effector_p/af3/foldseek_output"
...
for folder in "$AF3_DIR"/*; do
    ...
    echo "Moved ${id}_model.cif to 08_cluster_all/af3/cif"
...
CUDA_VISIBLE_DEVICES=0 foldseek easy-search \
    ${AF3_CIF} \
    ${AF3_CIF} \
    ${FDSK_OUT}/af3_foldseek_results.tsv \
    ${AF3_TMP} \
