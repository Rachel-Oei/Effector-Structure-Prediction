...
def main():
    ...
    results_to_tsv(tmalign_folder, output_dir, model1, metadata_file_esm)

    model2="af2"
    metadata_file_af2 = f"{home_dir}/04_results_tsv/pdb_metadata_esm.tsv"
    results_to_tsv(tmalign_folder, output_dir, model2, metadata_file_af2)

    model3="af3"
    metadata_file_af3 = f"{home_dir}/04_results_tsv/pdb_metadata_af2.tsv"
    results_to_tsv(tmalign_folder, output_dir, model3, metadata_file_af3)
